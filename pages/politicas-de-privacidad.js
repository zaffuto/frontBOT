...
export default function Politicas() {
  return (
    <Fragment>
      <Header title="Políticas de Privacidad" />
            ...
            <div className="row align-content-start align-items-center">
              <div className="col-12 col-sm-12 col-md-10 mx-auto">
                ...
                <h2 className="text-center">
                  Y protección de datos personales Smarter Bot
                </h2>
                <hr />
                <a href="#1">
                  <p>
                ...
                <p>
                  <strong>Smarter Bot SpA o Smarter Bot:</strong> es una empresa
                  y sociedad por acciones chilena constituida por escritura
                  ...
                  con distintos Proveedores a lo largo de todo el país. Smarter
                  Bot no es un centro de esquí, un centro de ocio o recreativo,
                  un club de salud, instalación, o establecimiento similar; ni
                  tiene, opera ni controla ninguna de las ofertas de servicios y
                  productos que se ofrecen a través de la Plataforma.
                </p>
                <p>
                ...
                <p>
                  ...
                  en que Smarter Bot recopila, usa, comparte y protege la
                ...
                <p>
                  ...
                  Smarter Bot en cuanto le compete las decisiones relacionadas
                ...
                se recolectan a través de la Plataforma de Smarter Bot. Los
                ...
                personas naturales de los Servicios otorgados por Smarter Bot,
                ...
                <p>
                  No será imputable a Smarter Bot, siempre que éste haya
                  ...
                  datos inexactos: (a) hubiesen sido obtenidos por Smarter Bot
                  directamente del Usuario, (b) hubieren sido obtenidos por
                  Smarter Bot de un intermediario, que recoja a nombre de
                  Smarter Bot los datos del Usuario, o (c) hubieren sido
                  obtenidos de un registro público por Smarter Bot.
                </p>
                <h4>
                  <strong>
                ...
                <p>
                  Perfil del Usuario: Smarter Bot recopila los datos que brindan
                  los Usuarios cuando crean o actualizan sus cuentas en la
                  Plataforma, lo que puede incluir, nombre, correo electrónico,
                  número de teléfono, número de cédula de identidad, dirección,
                  contraseña, foto de perfil, detalles bancarios o de pago
                  (incluyendo aquellos relacionados con su verificación), y
                  otros documentos de identificación gubernamentales que
                  muestren foto, genero, fecha de nacimiento y número de
                  documento.
                </p>
                <p>
                  Smarter Bot puede utilizar las fotografías enviadas por los
                  Usuarios para comprobar su identidad mediante tecnologías de
                  verificación facial.
                </p>
                <p>
                  Datos demográficos: Smarter Bot recopila información
                  demográfica sobre los Usuarios, incluso a través de encuestas
                  destinadas a ellos.
                </p>
                <p>
                  Otros datos: Smarter Bot recopila los datos que los Usuarios
                ...
                <p>
                  ...
                  Smarter Bot recopila relativa a los menores de edad incluirá,
                  nombre, fecha de nacimiento, número de cédula de identidad y
                  número de teléfono. Al realizar el registro de los Usuarios
                  menores de edad, su padre, madre o tutor legal según
                ...
                <p>
                  Datos de ubicación: Smarter Bot recopila datos de ubicación
                ...
                <p>
                  Smarter Bot recopila esta información desde el momento en que
                  se crea el Usuario en la Plataforma y cada vez que la
                ...
                <p>
                  Información de transacciones: Smarter Bot recopila datos de
                ...
                <p>
                  Datos de uso: Smarter Bot recopila información sobre cómo los
                  Usuarios interactúan con los Servicios y Plataforma. Esto
                  ...
                  navegador. Adicionalmente, Smarter Bot puede recopilar datos
                  sobre los servicios o los sitios de terceros que se usan antes
                  de interactuar con la Plataforma y Servicios de Smarter Bot,
                ...
                <p>
                  Datos del dispositivo: Smarter Bot puede recopilar datos sobre
                  los dispositivos usados para acceder a la Plataforma y
                ...
                <p>
                  Datos de comunicación: Smarter Bot permitirá que los Usuarios
                  se comuniquen con Smarter Bot a través de la Plataforma. Para
                  brindar este servicio, Smarter Bot recibe ciertos datos
                  relacionados con las llamadas, mensajes u otras
                  comunicaciones, como su fecha, hora y contenido. Smarter Bot
                ...
                <p></p>
                <p>
                  Socios comerciales de Smarter Bot relacionados con tarjetas de
                  débito o de crédito emitidas por una institución financiera
                  asociada con Smarter Bot, en la medida en que se indique en
                  los Términos y Condiciones de la tarjeta.
                </p>
                <p>
                  Proveedores que ayudan a Smarter Bot a verificar la identidad
                  de los Usuarios, información de antecedentes, o que revisan
                  las cuentas de los Usuarios en relación con sanciones, lavado
                  de dinero o exigencias relativas a la identificación del
                  Usuario.
                </p>
                <p>Fuentes disponibles públicamente.</p>
                <p>
                  Proveedores de servicios de marketing o distribuidores de
                  datos, cuya información Smarter Bot usa con fines
                ...
                <p>
                  Smarter Bot puede combinar la información recopilada de estas
                  fuentes con otros datos que posea.
                </p>
                <hr />
                ...
                <p>
                  ...
                  de la solicitud que se realice, Smarter Bot podrá conservar la
                  información personal indicada precedentemente por motivos de
                  seguridad y control de fraude, en caso de existir dudas
                  razonables.
                </p>
                <hr />
                ...
                <p>
                  ...
                  proporcionó la información a Smarter Bot.
                </p>
                <p>
                  Para que Smarter Bot pueda comunicarse con los Usuarios acerca
                  de los Servicios, incluyendo actualizaciones u ofertas
                ...
                <p>
                  ...
                  y a otros que Smarter Bot pudiera ofrecer a futuro, incluidas
                ...
                <p>
                  ...
                  Smarter Bot, resolver disputas y ejecutar los Términos de Uso.
                </p>
                <p>
                ...
                <p>
                  Smarter Bot podrá compartir los Datos Personales que nos
                ...
                <p>
                  Smarter Bot podrá comunicar los Datos Personales de los
                  Usuarios a terceros, exclusivamente en las siguientes
                  circunstancias y previa suscripción entre Smarter Bot y el
                ...
                <p>
                  ...
                  Personales de los Usuarios que los propios de Smarter Bot y,
                  ...
                  entregue Smarter Bot;
                </p>
                <p>
                  Para programas conjuntos o copatrocinados y finalidades
                  promocionales: Cuando Smarter Bot desarrolle un programa o
                  ...
                  como parte la promoción, Smarter Bot informará de ello al
                ...
                <p>
                  ...
                  Smarter Bot, sus clientes y el público; En caso de que se
                  produzca una fusión o adquisición de todo o parte del Grupo
                  Empresarial del que forma parte Smarter Bot por un tercero, o
                  en caso de venta de o disposición de todo o parte de sus
                ...
                <p>
                  ...
                  podrá utilizar los Servicios prestados por Smarter Bot a
                  través de la Plataforma.
                </p>
                <p>
                  Sin perjuicio de haberse revocado la autorización para el
                  Tratamiento, Smarter Bot podrá conservar los Datos Personales
                  y la información proporcionada por los Usuarios debidamente
                  bloqueados por aquel periodo permitido por la legislación
                  vigente, a fin de poder cumplir con la normativa aplicable
                  legal y reglamentaria, y poder resolver eventuales disputas,
                  reclamos, requerimientos por parte de la autoridad, detectar
                  problemas o incidencias y solucionarlos, y dar cumplimiento a
                  lo dispuesto en los Términos de Uso.
                </p>
                <p>
                ...
                <p>
                  Smarter Bot considera que los Datos Personales y otra
                  ...
                  seguridad informática eficaces. Smarter Bot se obliga a
                ...
                <p>
                  Asimismo, Smarter Bot adoptará todas las medidas de seguridad
                  necesarias para garantizar la confidencialidad de los datos
                  recopilados por medios de formularios, encuestas o mecanismos
                  de registro de navegación web.
                </p>
                <hr />
                ...
                <h4>
                  <strong>
                    ¿Cambiará alguna vez Smarter Bot esta Política de
                    Privacidad?
                  </strong>
                </h4>
                <p>
                  ...
                  haya proporcionado dicho Usuario a Smarter Bot, tendrá
                ...
                <p>
                  ...
                  Usuario y Smarter Bot con motivo, causa u omisión de esta
